    ...
    <body>
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="Upload.php" class="active"><span class="las la-phone-square">Upload Phone Numbers</span></a>
                    </li>
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <button class="btn btn-primary btn-block" name="uplod" type="submit">Upload</button>
                <br>
