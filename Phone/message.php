        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="message.php" class="active"><span class="las la-comments">Configure Message to Beneficiaries</span></a>
                    </li>
                    <li>
                ...
                <div class="cards">
                    ...
                    <div class="card-single">
                        ...
                        <h1>Message to Send</h1><br>
                                  ...
                                  <button class="btn btn-primary btn-block" name="save" type="submit">Save</button><br>
