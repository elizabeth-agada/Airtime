    ...
    <body>
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                <ul>
                    <li>
                        <a href="Dashboard.php" class="active"><span class="las la-igloo">Dashboard</span></a>
                    </li>
                    <li>
        ...
        <div class="main-content">
            ...
            <main>
                ...
                <div class="cards">
                    ...
                    <div class="card-single">
                        <h1>Choose Event</h1><br>
            
                    </div>
                    
                      
                </div>
                                                  <button class="btn btn-primary btn-block" name="download" type="submit">Download</button><br>
